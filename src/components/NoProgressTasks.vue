<template>
	<div>
		<div v-for="item in user.data.noProgressTasks">
			<div v-if="user.showSearch === true">
		      ...
		      <div class="card-footer">
		        <edit-task :task="item" :category="'noProgressTasks'" />
		        <span>
		        ...
		        <span>
		          ...
		          <div class="dropdown-menu">
		          	<button class="dropdown-item" @click="() => moveModal(item, 'noProgressTasks', 'inProgressTasks')">In Progress</button>
		          	<button class="dropdown-item" @click="() => moveModal(item, 'noProgressTasks', 'completedTasks')">Completed</button>
		          </div>
		        </span>
		      </div>
		    </div>
